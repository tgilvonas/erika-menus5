...
function validateDietType() {
    ...
    for (let property of dietTypeFields) {
        if (
            property !== 'title' &&
            (typeof dietType[property] === 'undefined' ||
                isNaN(dietType[property]))
        ) {
...
function saveDietType() {
    ...
    if (formIsValid.value) {
        ...
        axios
            .post(route('diet_types.save'), dietTypePostObject)
            .then((response) => {
    ...
    >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <div
                    v-if="errors.proteins_min.length"
                    class="mt-1 text-sm text-red-600"
                >
            ...
            <div>
                ...
                <div
                    v-if="errors.proteins_max.length"
                    class="mt-1 text-sm text-red-600"
                >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <div
                    v-if="errors.carbohydrates_min.length"
                    class="mt-1 text-sm text-red-600"
                >
            ...
            <div>
                ...
                <div
                    v-if="errors.carbohydrates_max.length"
                    class="mt-1 text-sm text-red-600"
                >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <div
                    v-if="errors.calories_min.length"
                    class="mt-1 text-sm text-red-600"
                >
            ...
            <div>
                ...
                <div
                    v-if="errors.calories_max.length"
                    class="mt-1 text-sm text-red-600"
                >
